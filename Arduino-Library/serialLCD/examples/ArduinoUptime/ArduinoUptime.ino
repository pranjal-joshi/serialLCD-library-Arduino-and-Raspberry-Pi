...
void setup()
{
	...
	lcd.println("Arduino Uptime:");	// print the text on lcd & goto next line
}

void loop()
{
	unsigned int cnt;
	lcd.setCursor(1,2);		// cursor to 1st coloumn 2nd row
	cnt = millis()/1000;	// get uptime in seconds
	lcd.printNum(cnt);		// print number
	lcd.print(" Sec.");
